  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full transition-colors duration-300 hover:bg-[#f6f5f3] pt-[48px] pb-[40px] max-md:pt-[32px] max-md:pb-[28px] px-[56px] max-md:px-[24px]">
        <div className="max-w-[1400px] mx-auto flex gap-[40px] items-start max-[1280px]:flex-col max-[1280px]:gap-[24px] max-lg:flex-col max-lg:gap-[24px]">
          {/* Logo */}
          <div className="flex flex-col h-[40px] items-start shrink-0 w-[180px] max-[1280px]:w-full max-md:w-[140px]">
          ...
          {/* Description */}
          <p className="font-['Manrope',sans-serif] font-[500] text-[#191e25] text-[16px] leading-[normal] w-[700px] shrink-0 max-[1280px]:w-full max-[1280px]:max-w-[700px] max-lg:w-full max-lg:max-w-[700px] max-md:text-[14px]">
            {desc}
          </p>

          {/* Services */}
          <div className="flex flex-col gap-[8px] flex-1 min-w-[180px] max-[1280px]:w-full max-[1280px]:min-w-0 max-lg:min-w-0">
