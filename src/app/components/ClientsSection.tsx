...
function SantanderLogo() {
  return (
    <div className="h-[35px] w-[199px] relative shrink-0">
...
function AtrapaloLogo() {
  return (
    <div className="h-[48px] w-[171px] relative shrink-0">
...
function FinsaLogo() {
  return (
    <div className="h-[40px] w-[131px] relative shrink-0 overflow-clip">
...
function GrupoPlanetaLogo() {
  return (
    <div className="h-[40px] w-[220px] relative shrink-0 overflow-clip">
...
function ElecnorLogo() {
  return (
    <div className="h-[41px] w-[107px] relative shrink-0 overflow-clip">
...
function TefalLogo() {
  return (
    <div className="h-[27px] w-[190px] relative shrink-0">
...
function PCcomLogo() {
  return (
    <div className="h-[40px] w-[116px] relative shrink-0 overflow-clip">
...
function YoigoLogo() {
  return (
    <div className="h-[48px] w-[155px] relative shrink-0">
...
function EmagisterLogo() {
  return (
    <div className="h-[40px] w-[138px] relative shrink-0">
...
function MeridaLogo() {
  return (
    <div className="h-[29px] w-[200px] relative shrink-0">
...
function BBVALogo() {
  return (
    <div className="h-[40px] w-[134px] relative shrink-0">
...
function SoderbergLogo() {
  return (
    <div className="h-[48px] w-[163px] relative shrink-0 overflow-clip">
...
function NavilensLogo() {
  return (
    <div className="h-[60px] w-[164px] relative shrink-0 overflow-clip">
...
function IVooxLogo() {
  return (
    <div className="h-[40px] w-[151px] relative shrink-0">
